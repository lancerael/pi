import { useRef as M, useState as P, useCallback as R, useEffect as N } from "react";
...
function Z(e, n, t) {
  var i, a, d, u, o, f, s = 0, m = !1, l = !1, v = !0;
  if (typeof e != "function")
    throw new TypeError(k);
  n = S(n) || 0, y(t) && (m = !!t.leading, l = "maxWait" in t, d = l ? V(S(t.maxWait) || 0, n) : d, v = "trailing" in t ? !!t.trailing : v);
  function h(r) {
    var c = i, p = a;
...
const ie = A.div(
  ...
  const a = M(null), [d, u] = P({
    x: t,
    y: i
  }), o = R((f, s) => {
    var m, l;
    return u({
      x: f - ((l = (m = a.current) == null ? void 0 : m.clientWidth) != null ? l : 0) / 2,
      y: s + 24
    });
  }, [a.current]);
  return N(() => {
