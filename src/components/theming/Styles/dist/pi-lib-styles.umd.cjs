...
`,p=l(),u=({color:t,isSpecial:f}={})=>{const a=f?"special":"border",c=f?"specialText":"textSoft",g=f?"specialBg":"subtle";return`
  ...
  `};e.GlobalStyle=p,e.Theme=n,e.baseTheme=b,e.box=u,e.getGlobalStyle=l,e.getTheme=d,Object.defineProperties(e,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
