...
const p = {
  ...
  k = ({ children: e, themeName: t = 'pebble', theme: a = r(t) }) => {
    const f = d(a)
    return /* @__PURE__ */ i(l, {
      theme: a,
      children: [/* @__PURE__ */ o(f, { theme: a }), e],
    })
  },
  w = (e, t) => (a) =>
    /* @__PURE__ */ o(k, {
      themeName: t,
      children: /* @__PURE__ */ o(e, { ...a }),
    }),
  c = (e) => Object.entries(e).reduce((t, [a, f]) => `${t} --${a}: ${f};`, ''),
  d = (
    { colors: { light: e, dark: t = e }, fonts: a, fontSizes: f } = r()
  ) => s`
  :root {
    ${c(e)}
    font-family: ${a.join(', ')};
...
`,
  T = d(),
  $ = ({ color: e, isSpecial: t } = {}) => {
    const a = t ? 'special' : 'border',
      f = t ? 'specialText' : 'textSoft',
      b = t ? 'specialBg' : 'subtle'
    return `
