...
import R, { keyframes as re, css as Yt } from 'styled-components'
import { jsx as k, jsxs as D, Fragment as ie } from 'react/jsx-runtime'
...
function oe(t, n) {
  var e = [],
    ...
    f = t === Kt || t === tn ? Ue : Ge
  function h(d) {
    var m = r == null ? (n.ticks ? n.ticks.apply(n, e) : n.domain()) : r,
      w = i == null ? (n.tickFormat ? n.tickFormat.apply(n, e) : We) : i,
      p = Math.max(o, 0) + u,
      g = n.range(),
      x = +g[0] + c,
      y = +g[g.length - 1] + c,
      A = (n.bandwidth ? Ze : Ke)(n.copy(), c),
      _ = d.selection ? d.selection() : d,
      b = _.selectAll('.domain').data([null]),
      N = _.selectAll('.tick').data(m, n).order(),
      S = N.exit(),
      M = N.enter().append('g').attr('class', 'tick'),
      C = N.select('line'),
      v = N.select('text')
    ;(b = b.merge(
      b
      ...
      (v = v.merge(
        M.append('text')
          ...
          .attr(l, a * p)
          .attr('dy', t === Kt ? '0em' : t === tn ? '0.71em' : '0.32em')
      )),
      d !== _ &&
        ((b = b.transition(d)),
        (N = N.transition(d)),
      ...
      b.attr(
        ...
        t === vt || t === $t
          ? s
            ? 'M' + a * s + ',' + x + 'H' + c + 'V' + y + 'H' + a * s
            : 'M' + c + ',' + x + 'V' + y
          : s
          ? 'M' + x + ',' + a * s + 'V' + c + 'H' + y + 'V' + a * s
          : 'M' + x + ',' + c + 'H' + y
      ),
      N.attr('opacity', 1).attr('transform', function (E) {
        return f(A(E) + c)
      }),
      C.attr(l + '2', a * o),
      v.attr(l, a * p).text(w),
      _.filter(Je)
        ...
        .attr('text-anchor', t === $t ? 'start' : t === vt ? 'end' : 'middle'),
      _.each(function () {
        this.__axis = A
      })
  }
...
function Wt(t) {
  ...
  return (
    ...
    An.hasOwnProperty(n) ? { space: An[n], local: t } : t
  )
}
function tr(t) {
  return function () {
...
function rr(t) {
  ...
  for (var n = this._groups, e = n.length, r = new Array(e), i = 0; i < e; ++i)
    for (
      var o = n[i], s = o.length, u = (r[i] = new Array(s)), c, a, l = 0;
      l < s;
      ++l
    )
      (c = o[l]) &&
        (a = t.call(c, c.__data__, l, o)) &&
        ('__data__' in c && (a.__data__ = c.__data__), (u[l] = a))
...
function vr(t, n, e, r, i, o, s) {
  ...
  for (u = 0; u < l; ++u)
    (c = n[u]) &&
      ((h[u] = d = s.call(c, c.__data__, u, n) + ''),
      a.has(d) ? (i[u] = c) : a.set(d, c))
  for (u = 0; u < f; ++u)
    (d = s.call(t, o[u], u, o) + ''),
      (c = a.get(d))
        ? ((r[u] = c), (c.__data__ = o[u]), a.delete(d))
        : (e[u] = new It(t, o[u]))
  for (u = 0; u < l; ++u) (c = n[u]) && a.get(h[u]) === c && (i[u] = c)
}
function _r(t) {
  return t.__data__
}
function br(t, n) {
  ...
  for (
    ...
    var l = r[a],
      f = i[a],
      h = f.length,
      d = kr(t.call(l, l && l.__data__, a, r)),
      m = d.length,
      w = (u[a] = new Array(m)),
      p = (s[a] = new Array(m)),
      g = (c[a] = new Array(h))
...
function Nr(t) {
  for (
    ...
    for (
      var a = e[c], l = r[c], f = a.length, h = (u[c] = new Array(f)), d, m = 0;
      m < f;
      ++m
    )
      (d = a[m] || l[m]) && (h[m] = d)
...
function $r(t) {
  ...
  for (
    ...
    for (
      var s = e[o], u = s.length, c = (i[o] = new Array(u)), a, l = 0;
      l < u;
      ++l
    )
      (a = s[l]) && (c[l] = a)
...
function Wr(t, n, e) {
  return arguments.length > 1
    ? this.each(
        (n == null ? Vr : typeof n == 'function' ? Yr : Br)(
          t,
          n,
          e == null ? '' : e
        )
...
function it(t, n) {
  return (
    ...
    fe(t).getComputedStyle(t, null).getPropertyValue(n)
  )
}
function Ur(t) {
  return function () {
...
function Zr(t, n) {
  return arguments.length > 1
    ? this.each((n == null ? Ur : typeof n == 'function' ? Kr : Gr)(t, n))
    : this.node()[t]
}
function he(t) {
...
function ge(t, n) {
  for (var e = dn(t), r = -1, i = n.length; ++r < i; ) e.add(n[r])
}
function pe(t, n) {
  for (var e = dn(t), r = -1, i = n.length; ++r < i; ) e.remove(n[r])
}
function Jr(t) {
  return function () {
    ge(this, t)
...
function ii(t) {
  return arguments.length
    ? this.each(t == null ? ni : (typeof t == 'function' ? ri : ei)(t))
...
function ui(t) {
  return arguments.length
    ? this.each(t == null ? oi : (typeof t == 'function' ? ai : si)(t))
    : this.node().innerHTML
}
function ci() {
...
function pi(t, n) {
  var e = typeof t == 'function' ? t : se(t),
    r = n == null ? gi : typeof n == 'function' ? n : hn(n)
  return this.select(function () {
...
function Ni(t, n, e) {
  ...
  for (u = n ? Ai : Mi, i = 0; i < o; ++i) this.each(u(r[i], n, e))
  return this
}
function me(t, n, e) {
  var r = fe(t),
...
function K(t) {
  return typeof t == 'string'
    ? new I([[document.querySelector(t)]], [document.documentElement])
    : new I([[t]], ye)
}
const Li = 500,
  L = 10,
  ...
  _t = (t = '', n, e) => {
    var f
    const r = Math.round((f = e.bandwidth) == null ? void 0 : f.call(e)) || 0,
      i = `${t}-${n}-${r}`
    if (Zt[i] !== void 0) return Zt[i]
    let o = ''
    const s = new Date(t),
      [u, c, a] = t.split('-')
    a === '01' &&
    ...
    return (
      r > 1 && l.push(16),
      r > 3 && l.push(8, 24),
      r > 7 && (l = [4, 7, 10, 13, 16, 19, 22, 25, 28]),
      l.includes(Number(a)) && (o = a),
      e.domain().length - 1 === n && (o = a),
      (Zt[i] = o),
      o
    )
  },
  Di = (t, n, e, r) => {
    ...
    P(() => {
      !t.current ||
        (K(t.current).select('g.x-axis, y.y-axis').remove(),
        o(
          K(t.current)
            .append('g')
      ...
      P(() => {
        !c.domain ||
          ...
          (i
            .call(je(c))
            .attr('transform', `translate(${h},${f - G[0]})`)
            .selectAll('text')
            .classed('emphasise', (w, p) => _t(w, p, c).length > 2)
            .attr('text-anchor', 'end')
            .attr('x', () => -16)
            .attr('y', -4)
            .attr('transform', 'rotate(270)')
            .text((w, p) => _t(w, p, c)),
          i.selectAll('line.clone').remove(),
          i
            .selectAll('line')
            .attr('y2', (w, p) => (_t(w, p, c).length ? 12 : 6))
            .each((w, p, g) => {
          ...
          s.call(Qe(a)).attr('transform', `translate(${l - G[1] + L}, 0)`),
          s.selectAll('line.clone').remove(),
          s.selectAll('line').each((w, p, g) => {
            var x = g[p].parentNode.appendChild(g[p].cloneNode(!0))
            K(x)
              .classed('clone', !0)
              .attr('x2', -l + 1 + G[1])
...
Et.prototype = xe.prototype = {
  ...
  on: function (t, n) {
    ...
    if (arguments.length < 2) {
      for (; ++o < s; )
        if ((i = (t = r[o]).type) && (i = Fi(e[i], t.name))) return i
      return
    }
...
var ot = 0,
  ...
  Q = 0,
  Ut = 0,
  ft = typeof performance == 'object' && performance.now ? performance : Date,
  _e =
...
zt.prototype = be.prototype = {
  ...
  restart: function (t, n, e) {
    ...
    ;(e = (e == null ? gn() : +e) + (n == null ? 0 : +n)),
      !this._next &&
        ct !== this &&
        (ct ? (ct._next = this) : (Rt = this), (ct = this)),
      (this._call = t),
      (this._time = e),
      en()
  },
...
function qi() {
  for (var t, n = Rt, e, r = 1 / 0; n; )
    n._call
      ...
      : ((e = n._next), (n._next = null), (n = t ? (t._next = e) : (Rt = e)))
  ;(ct = t), en(r)
}
function en(t) {
  if (!ot) {
    ...
    var n = t - Q
    n > 24
      ? (t < 1 / 0 && (ut = setTimeout(Sn, t - ft.now() - Ut)),
        at && (at = clearInterval(at)))
      : (at || ((Dt = ft.now()), (at = setInterval(Xi, ve))), (ot = 1), _e(Sn))
  }
}
function $n(t, n, e) {
  var r = new zt()
...
var Vi = xe('start', 'end', 'cancel', 'interrupt'),
  Bi = [],
  ke = 0,
  En = 1,
  rn = 2,
...
function Yi(t, n, e) {
  ...
  function s(a) {
    ...
    if (
      ($n(function () {
        e.state === Ct &&
          ((e.state = Cn), e.timer.restart(u, e.delay, e.time), u(a))
      }),
      (e.state = rn),
      ...
      for (
        e.state = Ct, i = new Array((h = e.tween.length)), l = 0, f = -1;
        l < h;
        ++l
      )
    ...
    for (
      var l =
          a < e.duration
            ...
            : (e.timer.restart(c), (e.state = on), 1),
        f = -1,
        h = i.length;
      ++f < h;
...
var ht = 0.7,
  ...
  X = '\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*',
  Gi = /^#([0-9a-f]{3,8})$/,
  Ki = new RegExp(`^rgb\\(${rt},${rt},${rt}\\)$`),
  Zi = new RegExp(`^rgb\\(${X},${X},${X}\\)$`),
  Ji = new RegExp(`^rgba\\(${rt},${rt},${rt},${dt}\\)$`),
  Qi = new RegExp(`^rgba\\(${X},${X},${X},${dt}\\)$`),
  ji = new RegExp(`^hsl\\(${dt},${X},${X}\\)$`),
  to = new RegExp(`^hsla\\(${dt},${X},${X},${dt}\\)$`),
  Tn = {
    aliceblue: 15792383,
...
function ro(t) {
  return (
    t instanceof pt || (t = j(t)),
    t ? ((t = t.rgb()), new T(t.r, t.g, t.b, t.opacity)) : new T()
  )
}
function sn(t, n, e, r) {
  return arguments.length === 1 ? ro(t) : new T(t, n, e, r == null ? 1 : r)
}
function T(t, n, e, r) {
...
mn(
  ...
  Me(pt, {
    ...
    clamp() {
      return new T(J(this.r), J(this.g), J(this.b), Ft(this.opacity))
    },
    displayable() {
      return (
        -0.5 <= this.r &&
...
function Ae(t) {
  ...
  if ((t instanceof pt || (t = j(t)), !t)) return new O()
  ...
  return (
    u
      ? (n === o
        ...
        (s *= 60))
      : (u = c > 0 && c < 1 ? 0 : s),
    new O(s, u, c, t.opacity)
  )
}
function oo(t, n, e, r) {
  return arguments.length === 1 ? Ae(t) : new O(t, n, e, r == null ? 1 : r)
}
function O(t, n, e, r) {
...
mn(
  ...
  Me(pt, {
    ...
    clamp() {
      return new O(Fn(this.h), kt(this.s), kt(this.l), Ft(this.opacity))
    },
    displayable() {
      return (
...
const Pt = (function t(n) {
  var e = uo(n)
  function r(i, o) {
    var s = e((i = sn(i)).r, (o = sn(o)).r),
      u = e(i.g, o.g),
      c = e(i.b, o.b),
      a = Ne(i.opacity, o.opacity)
    return function (l) {
      return (
        (i.r = s(l)), (i.g = u(l)), (i.b = c(l)), (i.opacity = a(l)), i + ''
      )
    }
  }
  return (r.gamma = t), r
...
function Se(t, n) {
  var e = (an.lastIndex = Qt.lastIndex = 0),
    r,
    i,
    o,
    s = -1,
  ...
  return (
    ...
    u.length < 2
      ...
      : ((n = c.length),
        function (a) {
          for (var l = 0, f; l < n; ++l) u[(f = c[l]).i] = f.x(a)
          return u.join('')
        })
  )
}
...
function xo(t) {
  return t == null ||
    ...
    ? un
    : ((t = t.matrix), $e(t.a, t.b, t.c, t.d, t.e, t.f))
}
function Ee(t, n, e, r) {
  function i(a) {
  ...
  function s(a, l, f, h) {
    a !== l
      ? (a - l > 180 ? (l += 360) : l - a > 180 && (a += 360),
        h.push({ i: f.push(i(f) + 'rotate(', null, r) - 2, x: z(a, l) }))
      : l && f.push(i(f) + 'rotate(' + l + r)
  }
  function u(a, l, f, h) {
    a !== l
      ? h.push({ i: f.push(i(f) + 'skewX(', null, r) - 2, x: z(a, l) })
  ...
  return function (a, l) {
    ...
    return (
      (a = t(a)),
      (l = t(l)),
      o(a.translateX, a.translateY, l.translateX, l.translateY, f, h),
      s(a.rotate, l.rotate, f, h),
      u(a.skewX, l.skewX, f, h),
      c(a.scaleX, a.scaleY, l.scaleX, l.scaleY, f, h),
      (a = l = null),
      function (d) {
        for (var m = -1, w = h.length, p; ++m < w; ) f[(p = h[m]).i] = p.x(d)
        return f.join('')
      }
    )
  }
}
var vo = Ee(wo, 'px, ', 'px)', 'deg)'),
  _o = Ee(xo, ', ', ')', ')')
function bo(t, n) {
  var e, r
  return function () {
...
function To(t, n) {
  ...
  return this.attrTween(
    t,
    typeof n == 'function'
      ? (e.local ? Co : Eo)(e, r, xn(this, 'attr.' + t, n))
      : n == null
      ? (e.local ? No : Ao)(e)
      : (e.local ? $o : So)(e, r, n)
  )
...
function Po(t) {
  var n = this._id
  return arguments.length
    ? this.each((typeof t == 'function' ? Oo : Fo)(n, t))
    : H(this.node(), n).delay
}
function Ho(t, n) {
  return function () {
...
function qo(t) {
  var n = this._id
  return arguments.length
    ? this.each((typeof t == 'function' ? Ho : Xo)(n, t))
...
function Go(t) {
  ...
  for (
    ...
    for (
      var c = n[u], a = e[u], l = c.length, f = (s[u] = new Array(l)), h, d = 0;
      d < l;
      ++d
    )
      (h = c[d] || a[d]) && (f[d] = h)
...
function ts(t) {
  ...
  for (var r = this._groups, i = r.length, o = new Array(i), s = 0; s < i; ++s)
    for (
      var u = r[s], c = u.length, a = (o[s] = new Array(c)), l, f, h = 0;
      h < c;
      ++h
    )
      (l = u[h]) &&
        (f = t.call(l, l.__data__, h, u)) &&
        ('__data__' in l && (f.__data__ = l.__data__),
        (a[h] = f),
        Gt(a[h], n, e, h, a, H(l, e)))
...
function is(t, n) {
  ...
  return function () {
    var o = it(this, t),
      s = (this.style.removeProperty(t), it(this, t))
...
function ss(t, n, e) {
  ...
  return function () {
    var s = it(this, t),
      ...
      c = u + ''
    return (
      u == null && (c = u = (this.style.removeProperty(t), it(this, t))),
...
function as(t, n) {
  ...
  return function () {
    var c = q(this, t),
      a = c.on,
      l = c.value[o] == null ? u || (u = Te(n)) : void 0
...
function us(t, n, e) {
  ...
  return n == null
    ? this.styleTween(t, is(t, r)).on('end.style.' + t, Te(t))
    : typeof n == 'function'
    ? this.styleTween(t, ss(t, r, xn(this, 'style.' + t, n))).each(
        as(this._id, t)
      )
    : this.styleTween(t, os(t, r, n), e).on('end.style.' + t, null)
}
function cs(t, n, e) {
  return function (r) {
...
function fs(t, n, e) {
  ...
  if (typeof n != 'function') throw new Error()
  return this.tween(r, ls(t, n, e == null ? '' : e))
}
function hs(t) {
  return function () {
    this.textContent = t
...
function Ms(t) {
  ...
  t instanceof W
    ? ((n = t._id), (t = t._name))
    : ((n = Le()), ((e = bs).time = gn()), (t = t == null ? null : t + ''))
...
const Hn = {
  ...
  As = (t, n, e, r, i) => {
    const {
      ...
      d = F(() => K(t.current), [t.current]),
      m = F((g, x = d()) => x.selectAll(`${Hn[g]}.${g}`).data(n), [n]),
      w = F(
        (g) => {
          var x
          return (
            (a.current[g] =
              (x = a.current[g]) != null
                ...
                : d()
                    .append('g')
                    .classed(`${g}-group`, !0)
                    .attr('clip-path', 'url(#chart-contents)')),
            a.current[g]
          )
        },
        [a]
      ...
      p = F(
        (g, x) => {
          ...
          const A = () => y.transition().duration(i ? Li : 50),
            _ = (M) =>
              Number(o(M.date)) + (g === 'wicks' ? +o.bandwidth() / 2 : 0) + c,
            b = (M) => u(M[x[0]], M[x[1]]),
            N = (M) => s(M[x[0]], M[x[1]]),
            S = (M) => b(M) + N(M)
          return (
            g === 'candles'
              ? (A()
                  ...
                  .attr('y', b),
                y
                  .classed('is-increased', (M) => M.close > M.open)
                  .classed('is-decreased', (M) => M.close < M.open)
                  .classed('is-zoomed', (M) => +o.bandwidth() > 10)
                  .on('click', ({ target: M }, C) => {
                    y.classed('is-active', !1),
                      K(M).classed('is-active', !0),
                      (l.current = !0),
                      h({
                        item: C,
                        position: {
              ...
              : A().attr('x1', _).attr('y1', b).attr('x2', _).attr('y2', S),
            y.classed(g, !0).exit().remove(),
            y
          )
        },
        [o, u]
    ...
    return (
      P(() => {
        ...
        const g = ({ target: x }) => {
          x.nodeName !== 'rect' &&
            (d().selectAll('rect').classed('is-active', !1),
            (l.current = !1),
            h(({ position: y }) => ({ item: void 0, position: y })))
        }
        return (
          addEventListener('resize', g),
          addEventListener('pointerdown', g),
          () => {
            removeEventListener('pointerdown', g),
      ...
      P(() => {
        var g
        ;(g = o == null ? void 0 : o.bandwidth) != null &&
          g.call(o) &&
          (p('wicks', ['low', 'high']), p('candles', ['open', 'close']))
      }, [o, u]),
      f
    )
  }
var At =
  ...
  Cs = /^0o[0-7]+$/i,
  Ts = parseInt,
  Ls = typeof At == 'object' && At && At.Object === Object && At,
  Is = typeof self == 'object' && self && self.Object === Object && self,
  Rs = Ls || Is || Function('return this')(),
  Ds = Object.prototype,
  zs = Ds.toString,
  Os = Math.max,
  Fs = Math.min,
...
function Ps(t, n, e) {
  var r,
    ...
    f = !1,
    h = !0
  if (typeof t != 'function') throw new TypeError(Ie)
  ;(n = qn(n) || 0),
    Ht(e) &&
      ((l = !!e.leading),
      (f = 'maxWait' in e),
      (o = f ? Os(qn(e.maxWait) || 0, n) : o),
  ...
  function _() {
    ...
    if (((r = arguments), (i = this), (c = b), N)) {
      ...
      if (f) return (u = setTimeout(g, n)), d(c)
    }
...
const { abs: Vs, round: Vn } = Math,
  ...
  Ws = (t = '') => new Date(t).toLocaleDateString('en-UK'),
  nt = (t = 0, n = 1e4) => Math.floor(Math.random() * (t - n - 1)) + n + 1,
  Bn = (t, n = 100) => Math.abs(t + (t - nt(t - n, t + n))),
  Us = (t, n) => {
    let r = new Date()
    r.setDate(r.getDate() - t)
    const i = n ? Bn(n.close, 3) : nt(100, 400),
      o = Bn(i, 50),
      s = nt(Math.max(i, o), Math.max(i, o) + 20),
      u = nt(Math.abs(Math.min(i, o) - 20), Math.min(i, o))
    return {
      date: Ys(r),
      high: s,
      low: u > 0 ? u : 0,
...
function Re(t) {
  let n, e, r
  t.length !== 2
    ? ((n = Lt), (e = (u, c) => Lt(t(u), c)), (r = (u, c) => t(u) - c))
    : ((n = t === Lt || t === Gs ? t : Ks), (e = t), (r = t))
  ...
  return (
    i < 0
      ...
      : ((a = Math.pow(10, i) * s),
        ...
        u * a < t && ++u,
        c * a > n && --c),
    c < u && 0.5 <= e && e < 2 ? qt(t, n, e * 2) : [u, c, a]
  )
}
function sa(t, n, e) {
  ...
  else if (s < 0) for (let a = 0; a < u; ++a) c[a] = (i + a) / -s
  else for (let a = 0; a < u; ++a) c[a] = (i + a) * s
  return c
}
function cn(t, n, e) {
...
function De() {
  ...
  return (
    ...
    vn.apply(i, arguments),
    i
  )
}
function ze() {
  var t = De().unknown(void 0),
    n = t.domain,
    e = t.range,
    r = 0,
    i = 1,
...
function ha(t, n, e) {
  var r = t[0],
    ...
    s = n[1]
  return (
    i < r ? ((r = ln(i, r)), (o = e(s, o))) : ((r = ln(r, i)), (o = e(o, s))),
    function (u) {
      return o(r(u))
    }
  )
...
function wa(t, n) {
  return function (e, r) {
    for (
      var i = e.length, o = [], s = 0, u = t[0], c = 0;
      i > 0 &&
      u > 0 &&
...
function ba(t, n) {
  ...
  var r = e[0],
    i = e[1],
    o = i - (Oe = Math.max(-8, Math.min(8, Math.floor(i / 3))) * 3) + 1,
    s = r.length
  return o === s
    ? r
    : o > s
    ...
    : '0.' + new Array(1 - o).join('0') + Vt(t, Math.max(0, n + o - 1))[0]
}
function Kn(t, n) {
  var e = Vt(t, n)
  if (!e) return t + ''
...
function ka(t) {
  ...
  function a(f) {
    ...
    function C(v) {
        ...
        if (
          ...
          for (tt = -1, bn = v.length; ++tt < bn; )
            if (((mt = v.charCodeAt(tt)), 48 > mt || mt > 57)) {
              ;($ = (mt === 46 ? i + v.slice(tt + 1) : v.slice(tt)) + $),
                (v = v.slice(0, tt))
              break
            }
        }
      ...
      x && !p && (v = n(v, 1 / 0))
      var wt = E.length + v.length + $.length,
        V = wt < g ? new Array(g - wt + 1).join(h) : ''
      switch (
        (x && p && ((v = n(V + v, V.length ? g - $.length : 1 / 0)), (V = '')),
        d)
      ) {
        case '<':
          v = E + v + $ + V
  ...
  function l(f, h) {
    var d = a(((f = Bt(f)), (f.type = 'f'), f)),
      m = Math.max(-8, Math.min(8, Math.floor(st(h) / 3))) * 3,
      w = Math.pow(10, -m),
      p = jn[8 + m / 3]
    return function (g) {
      return d(w * g) + p
...
function Ma(t) {
  return (Nt = ka(t)), (Fe = Nt.format), (Pe = Nt.formatPrefix), Nt
}
function Aa(t) {
...
function Na(t, n) {
  return Math.max(
    0,
    Math.max(-8, Math.min(8, Math.floor(st(n) / 3))) * 3 - st(Math.abs(t))
  )
}
function Sa(t, n) {
  return (
    (t = Math.abs(t)), (n = Math.abs(n) - t), Math.max(0, st(n) - st(t)) + 1
  )
}
function $a(t, n, e, r) {
  var i = aa(t, n, e),
  ...
  switch (((r = Bt(r == null ? ',f' : r)), r.type)) {
    case 's': {
      ...
      return (
        r.precision == null && !isNaN((o = Na(i, s))) && (r.precision = o),
        Pe(r, s)
      )
    }
    case '':
    ...
    case 'r': {
      r.precision == null &&
        !isNaN((o = Sa(i, Math.max(Math.abs(t), Math.abs(n))))) &&
...
function Ea(t) {
  ...
  return (
    (t.ticks = function (e) {
      var r = n()
      return sa(r[0], r[r.length - 1], e == null ? 10 : e)
    }),
    (t.tickFormat = function (e, r) {
      var i = n()
      return $a(i[0], i[i.length - 1], e == null ? 10 : e, r)
    }),
    (t.nice = function (e) {
      e == null && (e = 10)
      var r = n(),
        ...
        l = 10
      for (
        u < s && ((a = s), (s = u), (u = a), (a = i), (i = o), (o = a));
        l-- > 0;

      ) {
        if (((a = cn(s, u, e)), a === c)) return (r[i] = s), (r[o] = u), n(r)
        if (a > 0) (s = Math.floor(s / a) * a), (u = Math.ceil(u / a) * a)
        else if (a < 0) (s = Math.ceil(s * a) / a), (u = Math.floor(u * a) / a)
        else break
        c = a
      }
      return t
...
const { abs: Ca, min: te, max: Ta } = Math,
  La = (t, n) => {
    const { sizes: e, visibleRange: r } = n,
      [i, o] = Y({
        xScale: (c) => c,
        yScale: (c) => c,
      }),
      s = F((c, a) => Ca(i.yScale(a) - i.yScale(c)) || 1, [i.yScale]),
      u = F((c, a) => i.yScale(te(c, a)) - s(c, a) || 1, [i.yScale])
    return (
      P(() => {
        if (!(t != null && t.length)) return
        const { first: c, last: a, totalWidth: l } = r,
          { height: f } = e,
          h = t.slice(c > 0 ? c : 0, a),
          d = te(...h.map(({ low: g }) => g)),
          m = Ta(...h.map(({ high: g }) => g)),
      ...
      { utils: { scaledHeight: s, scaledY: u }, scales: i }
    )
  },
  Ia = R.div(
    ({ isVisible: t = !1 }) => Yt`
  ...
  Ra = ({ children: t, isVisible: n = !1, x: e = 0, y: r = 0 }) => {
    const i = lt(null),
      [o, s] = Y({
        x: e,
        y: r,
      ...
      u = F(
        (c, a) => {
          ...
          return s({
            x:
              c -
              ((f = (l = i.current) == null ? void 0 : l.clientWidth) != null
                ? f
                : 0) /
                2,
            y: a + 24,
    ...
    return (
      P(() => {
        u(e, r)
        const c = Xt(({ clientX: l, clientY: f }) => !e && !r && u(l, f), 100),
          a = () => {
          ...
          children: [
            /* @__PURE__ */ k('div', {
              children: /* @__PURE__ */ k('strong', {
                children: Ws(e == null ? void 0 : e.date),
              }),
            }),
            /* @__PURE__ */ D('div', {
              children: [
  ...
  Ya = (t, n) => {
    P(() => {
      ...
      const s = (p) => {
        ...
        f = ({ clientX: p, pointerId: g, pageX: x, pageY: y }) => {
          ...
          if (e)
            if ((A == null ? void 0 : A.length) === 2) {
              if (Object.keys(o).indexOf(`${g}`) !== 1) return
              o[g] = { pageX: x, pageY: y }
              const _ = A[0].pageX - A[1].pageX,
                b = A[0].pageY - A[1].pageY,
                N = Math.sqrt(_ * _ + b * b),
                S = i ? (i - N) / 120 : 0
              ;(i = N), s(S)
              return
        ...
        m = (p) => (p.pointerType === 'mouse' ? h(p) : f(p)),
        w = (p = 'remove', g) => {
          var A
          const x = window[`${p}EventListener`],
            y = (A = t.current) == null ? void 0 : A[`${p}EventListener`]
          x('pointerup', l),
            y == null || y('pointerdown', a),
            y == null || y('pointermove', m),
            y == null || y('wheel', d, g)
        }
...
`,
  ...
  ja = ({ data: t = [] }) => {
    const n = lt(null),
      ...
      o = La(t, i)
    Di(n, t, o.scales, i)
    const s = As(n, t, i, o, e.transition)
    return (
      Ya(n, r),
      /* @__PURE__ */ D(Va, {
        children: [
