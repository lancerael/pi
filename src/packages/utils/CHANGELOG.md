...
- Moved hooks and helpers to standalone (lancerael@googlemail.com)
...
- Added end callback to transition (lancerael@googlemail.com)
...
- Improved type definitions (lancerael@googlemail.com)
...
- Adding transient props helper (lancerael@googlemail.com)
...
- Adding docs (lancerael@googlemail.com)
