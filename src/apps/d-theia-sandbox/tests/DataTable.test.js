...
describe('DataTable', () => {
  ...
  let wrapper = {};
  const oChart = JSON.parse('{"aData":[{"sLabel":"Item 1","aValues":[46]}],"jConfig":{"sTitle":"Random Chart Data","aAxisLabels":["Y Axis","X Axis"],"aValues":[{"sName":"Type 1","sColor":"#c8425c","oColor":{"r":200,"g":66,"b":92,"opacity":1},"iLabelWidth":51.015625}],"bTrim":true}}');
  const handlers = {
